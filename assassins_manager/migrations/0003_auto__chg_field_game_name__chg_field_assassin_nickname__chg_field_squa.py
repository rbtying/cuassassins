...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'assassins_manager_game', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Assassin.nickname'
        db.alter_column(u'assassins_manager_assassin', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Squad.name'
        db.alter_column(u'assassins_manager_squad', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Game.name'
        db.alter_column(u'assassins_manager_game', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Assassin.nickname'
        db.alter_column(u'assassins_manager_assassin', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Squad.name'
        db.alter_column(u'assassins_manager_squad', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        u'assassins_manager.assassin': {
            ...
            'nickname': ('django.db.models.fields.CharField', [], {'default': "'John Doe'", 'max_length': '255'}),
